    ...
    <footer className="bg-[#050e20] text-white border-t border-white/5" role="contentinfo">
      <Container>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 py-14 lg:py-16">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-heading text-xs font-bold uppercase tracking-widest text-white mb-5">
              Quick Links
            </h3>
        ...
        <div className="border-t border-white/5 py-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/80">
