  ...
  return (
    <form onSubmit={handleSubmit(onSave)} className="space-y-4">
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-3">
        <div>
          <label className="text-xs font-semibold text-gray-600 block mb-1.5">Year <span className="text-red-400">*</span></label>
          <input {...register('year', { required: true })} placeholder="2024" className={inputCls} />
        </div>
        <div className="sm:col-span-2">
          <label className="text-xs font-semibold text-gray-600 block mb-1.5">Title <span className="text-red-400">*</span></label>
          <input {...register('title', { required: true })} className={inputCls} placeholder="Company founded" />
        </div>
        <div>
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-0.5">Company journey timeline shown on the About page.</p>
            </div>
          </div>
