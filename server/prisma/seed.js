...
async function main() {
  ...
  const services = [
    {
      ...
      shortDescription: 'Custom, responsive websites built with React, Node.js, and WordPress optimised for speed, SEO, and conversions.',
      fullDescription: 'We design and build bespoke web solutions that scale. From landing pages to full-stack enterprise platforms, our team delivers clean code, fast load times, and seamless user experiences. Every website is fully responsive and SEO-optimized.',
    ...
    },
    {
      ...
      shortDescription: 'Result-driven campaigns spanning SEO, Google Ads, Meta Ads, and content marketing to drive high-intent leads.',
      fullDescription: 'Our digital marketing strategies are built on data and focused on ROI. We run complete SEO campaigns to rank your business organically, paired with high-performance paid ads on Google and Instagram to drive immediate leads.',
    ...
    },
    {
      ...
      shortDescription: 'Strategic IT advisory to align your technology roadmap with business growth and help you choose the right systems.',
      fullDescription: 'Our expert consultants analyze your current business workflows, systems, and requirements to design a scalable IT strategy. We assist in vendor selection, cloud architecture design, and technology cost optimization.',
    ...
    },
    {
      ...
      shortDescription: 'End-to-end e-commerce store setup, checkout optimisation, inventory management, and secure payment gateway integrations.',
      fullDescription: 'We build feature-rich e-commerce stores with smooth checkout experiences, secure payment gateways, and automated inventory sync. From Shopify to custom React storefronts, we ensure your store is fast and optimized for conversions.',
    ...
    },
    {
      ...
      shortDescription: 'Secure cloud hosting setup, AWS/Google Cloud management, server scaling, and CI/CD workflows for zero downtime.',
      fullDescription: 'We manage cloud deployments on AWS, GCP, and DigitalOcean. Our DevOps workflows include automated CI/CD pipelines, containerized deployments with Docker, and server monitoring to ensure 99.9% uptime.',
    ...
    },
    {
      ...
      shortDescription: 'Premium UI/UX designs coupled with complete corporate brand identity systems, logos, and guidelines.',
      fullDescription: 'Our design team crafts modern, intuitive user interfaces and frictionless user experiences. We combine this with holistic brand identity design including logos, color palettes, and brand guidelines.',
    ...
    },
    {
      ...
      shortDescription: 'Native and cross-platform mobile apps built with React Native and Flutter, secure, high-performing, and App Store ready.',
      fullDescription: 'We design and build secure, fast mobile applications for iOS and Android. Using React Native and Flutter, we deliver native-like performance with a single codebase including push notifications, offline support, and App Store submission.',
      ...
      process: [
        ...
        { step: '03', title: 'Development', desc: 'React Native or Flutter codebase with API integrations.' },
  ...
  const projects = [
    {
      id: 'proj-1', title: 'E-Commerce Platform', slug: 'ecommerce-platform',
  ...
  const team = [
    {
      id: 'team-1', name: 'Mohammad Dilshan', role: 'Founder & CEO', order: 1,
      ...
      photoUrl: '', linkedinUrl: '#',
    },
    {
      id: 'team-2', name: 'Rohan Verma', role: 'Lead Software Architect', order: 2,
    ...
    {
      id: 'team-3', name: 'Priya Mehta', role: 'Head of UI/UX & Design', order: 3,
    ...
    {
      id: 'team-4', name: 'Karan Singhal', role: 'Head of Digital Marketing', order: 4,
  ...
  const testimonials = [
    {
      id: 'test-1', name: 'Aditya Sharma', role: 'Managing Director', company: 'Bhilwara Textiles Ltd.',
    ...
    {
      id: 'test-2', name: 'Meera Johar', role: 'Founder & CEO', company: 'Jaipur Crafts E-Store',
    ...
    {
      id: 'test-3', name: 'Rajesh Singhal', role: 'Owner', company: 'Singhal Marbles & Granites',
  ...
  const faqs = [
    ...
    { id: 'faq-3', question: 'Will my website be mobile-friendly and SEO optimized?', answer: 'Absolutely. Every layout is fully responsive and we implement on-page SEO best practices including schema markup, semantic HTML, and fast load times from day one.', order: 3, isActive: true },
